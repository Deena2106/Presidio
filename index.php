                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h1 class="display-6 fw-bolder text-white mb-2">Teachers Management System</h1>
                            ...
                            <a class="btn btn-success btn-lg px-4 me-sm-3" href="teacher/signup.php">Teacher's Register</a>
                                <a class="btn btn-outline-light btn-lg px-4" href="teacher/index.php">Teacher's Login</a>
                            </div>
                        </div>
                    </div>
